...
dl_folder="$HOME/Downloads/youtube-dl1"
...
readarray -t dbarray < <( jq -r '.roots.other.children[]| select(.name == "amp" and .type == "folder") |.children[].url|@sh' "$HOME/snap/chromium/common/chromium/Default/Bookmarks" )   
